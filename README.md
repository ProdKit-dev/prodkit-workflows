...
It replaces copied repository-specific release state machines with immutable, reusable GitHub Actions workflows. Consumer repositories retain only their domain-specific build/test adapters; release policy, source identity, supply-chain proof, publication semantics, runner routing, and organization drift detection live here.
