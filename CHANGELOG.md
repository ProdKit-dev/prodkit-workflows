...
- Lock `docs/CONTRACTS.md`, reusable workflow behavior, bootstrap output, manifest schema, runner-failover semantics, and local validators together with regression tests.
